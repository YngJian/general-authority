...
import com.example.authority.domain.mapper.LogMapper;
...
public class LogServiceImpl extends ServiceImpl<LogMapper, SystemLog> implements ILogService {
    ...
    public IPage<SystemLog> findLogs(SystemLog systemLog, QueryRequest request) {
        ...
        if (StringUtils.isNotBlank(systemLog.getCreateTimeFrom()) &&
            ...
            systemLog.setCreateTimeFrom(systemLog.getCreateTimeFrom() + AuthConstant.DAY_START_PATTERN_SUFFIX);
            systemLog.setCreateTimeTo(systemLog.getCreateTimeTo() + AuthConstant.DAY_END_PATTERN_SUFFIX);
        }
        ...
        SortUtil.handlePageSort(request, page, "createTime", AuthConstant.ORDER_DESC, true);
