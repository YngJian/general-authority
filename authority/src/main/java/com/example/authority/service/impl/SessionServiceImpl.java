...
import com.example.authority.domain.entity.ActiveUser;
...
import com.example.authority.utils.DateUtil;
...
public class SessionServiceImpl implements ISessionService {
    ...
    public List<ActiveUser> list(String username) {
        ...
        for (Session session : sessions) {
            ...
            activeUser.setStatus(timeout == 0L ? ActiveUser.OFFLINE : ActiveUser.ONLINE);
