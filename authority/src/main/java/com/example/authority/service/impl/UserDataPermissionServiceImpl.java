...
import com.example.authority.domain.entity.UserDataPermission;
import com.example.authority.domain.mapper.UserDataPermissionMapper;
...
public class UserDataPermissionServiceImpl extends ServiceImpl<UserDataPermissionMapper, UserDataPermission> implements IUserDataPermissionService {
    ...
    public void deleteByDeptIds(List<String> deptIds) {
        baseMapper.delete(new LambdaQueryWrapper<UserDataPermission>()
                .in(UserDataPermission::getDeptId, deptIds));
    }
    ...
    public void deleteByUserIds(String[] userIds) {
        ...
        baseMapper.delete(new LambdaQueryWrapper<UserDataPermission>()
                .in(UserDataPermission::getUserId, list));
    }
